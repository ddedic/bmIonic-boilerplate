...
gulp.task('styles', function() {
  ...
  var ionicStream = gulp.src(['app/styles/ionic-styles.scss', 'bower_components/ion-datetime-picker/src/picker.scss'])
  ...
  var mergedStream = merge(ionicStream, cssStream, sassStream);


  return streamqueue({ objectMode: true }, mergedStream)
...
gulp.task('scripts', function() {
  ...
  var templateStream = gulp
    .src('*/views/**/*.html', { cwd: 'app/scripts'})
...
gulp.task('watchers', function() {
  ...
  gulp.watch('app/scripts/*/views/**/*.html', ['index']);
